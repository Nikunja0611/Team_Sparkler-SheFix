...
const Register = () => {
  ...
  const validateStep1 = () => {
    ...
    if (!formData.phone.trim() || formData.phone.length < 10) return alert("Please enter a valid 10-digit Mobile Number");
    if (!formData.password.trim()) return alert("Please create a Password");
    setStep(2);
  };

  const validateStep2 = () => {
    if (!formData.idCard) return alert("Please upload your Identity Proof (Aadhaar or Driving Licence).");
    setStep(3);
  };
        ...
        <div className="p-8">
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="flex gap-3">
                <button onClick={() => setStep(1)} className="flex-1 py-3 text-gray-500 font-medium hover:bg-gray-100 rounded-xl">Back</button>
                <button 
                  onClick={validateStep2}
                  className="flex-1 bg-shePurple text-white py-3 rounded-xl font-bold hover:bg-purple-800 transition"
                >
                  Start Video KYC
                </button>
              </div>
          ...
          {step === 3 && (
            <div className="animate-fadeIn text-center">
              ...
              {/* Video Component */}
              <div className="border-4 border-shePurple rounded-xl overflow-hidden mb-4 bg-black">
          ...
          {step === 4 && (
            <div className="text-center animate-fadeIn space-y-6">
              ...
              <button 
                ...
                disabled={loading}
                className="w-full bg-shePurple text-white py-4 rounded-xl font-bold hover:bg-purple-800 transition shadow-lg disabled:opacity-70"
              >
